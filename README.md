...
Career facts are maintained in [career-data](career-data/README.md). The resume and CV use Markdown as their primary source, with synchronized Word and PDF versions. See the [maintenance instructions](AGENTS.md) and [document generation guide](scripts/README.md).
